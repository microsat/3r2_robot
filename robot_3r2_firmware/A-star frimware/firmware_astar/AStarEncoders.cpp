...
int16_t AStarEncoders::getCountsLeft()
{
    init();
...
int16_t AStarEncoders::getCountsRight()
{
    init();
...
int16_t AStarEncoders::getCountsAndResetLeft()
{
    init();
...
int16_t AStarEncoders::getCountsAndResetRight()
{
    init();
...
bool AStarEncoders::checkErrorLeft()
{
    init();
...
bool AStarEncoders::checkErrorRight()
{
    init();
